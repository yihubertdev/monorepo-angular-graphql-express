...
export const blogEditSchema = (
  ...
  return Joi.object({
    title: Joi.string()
      .optional()
      .messages({
        "string.base": `'title' should be a type of 'string', user input is ${String(
          data.title
        )}`,
    ...
    subTitle: Joi.string()
      .optional()
      .messages({
        "string.base": `'subTitle' should be a type of 'string', user input is ${String(
          data.subTitle
        )}`,
    ...
    alt: Joi.string()
      .optional()
      .messages({
        "string.base": `'alt' should be a type of 'string', user input is ${String(
          data.alt
        )}`,
