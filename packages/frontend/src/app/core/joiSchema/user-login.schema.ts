...
export const userLoginSchema = (errorLocation: string, data: IUserLogin): Joi.ObjectSchema => {
  return Joi.object({
    email: Joi.string()
      .optional()
...
export const userSignUpSchema = (errorLocation: string, data: IUserSignUpForm): Joi.ObjectSchema => {
  return Joi.object({
    username: Joi.string()
      .required()
      .messages({
