...
import { FIRESTORE_COLLECTION, FIRESTORE_SUBCOLLECTION, IRoom } from "type-sources";
...
export class RoomService extends FireStoreBaseModel<IRoom.IBase> {
  ...
  public serializer(input: Omit<IRoom.IBase, "createdAt" | "updatedAt">): IRoom.IBase {
    return {
      ...input,
  ...
  public listenOffer({
    ...
    return room.collection(FIRESTORE_SUBCOLLECTION.OFFER).where("userId", "!=", userId);
  }
  ...
  public listenAnswer({
    ...
    return room.collection(FIRESTORE_SUBCOLLECTION.ANSWER).where("userId", "!=", userId);
  }
  ...
  public listenICE({
    ...
    return room.collection(FIRESTORE_SUBCOLLECTION.ICE).where("userId", "!=", userId);
  }
