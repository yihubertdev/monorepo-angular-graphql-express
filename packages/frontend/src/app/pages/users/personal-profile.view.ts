...
import { PERSONAL_PROFILE_SETTINGS_MENU } from "../personalProfile";
...
export default class PersonalProfileView implements OnInit {
  public menus: IMenu[] = PERSONAL_PROFILE_SETTINGS_MENU;
