export declare const enum FIRESTORE_COLLECTION {
    users = "users",
    blogs = "blogs",
    posts = "posts",
    payment = "payment",
...
export declare const enum FIREAUTH_PERSISTENCE {
    SESSION = "SESSION",
    LOCAL = "LOCAL",
    NONE = "NONE"
}
export declare const enum SNACKBAR_ERROR {
...
export declare const enum SNACKBAR_ACTION {
    TOP = "top",
    BOTTOM = "bottom",
    START = "start",
    CENTER = "center",
...
export declare const enum IUserRole {
    EDITOR = "EDITOR",
    VISITOR = "VISITOR",
    ADMIN = "ADMIN"
}
